...
3. The heroine show page should include the heroine's name (eg. Kamala Khan), its super name (eg. Ms. Marvel), and its power. The power should link to the power show page.  

4. The power show page should have its name and description.

5. As a visitor to the website, I should be able to create a new heroine with its name and super name.
